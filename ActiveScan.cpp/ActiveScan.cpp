//File Name: ActiveScan.cpp
//Authors: Adam Mejia
//Email: adamrooski@gmail.com
//Description: This program will take 2 light level readings per axis of rotation at different points in space, compare them and move in the direction with the most light.
